					...
					<section class="poderes-habilidades">
						<xsl:for-each select="/pokedex/types/type">
							...
							<div class="poderes-habilidades_box">
								...
								<span>a: <xsl:value-of select="types/type"/>
								</span>
							</div>
						</xsl:for-each>
					</section>
						...
						<xsl:for-each select="/pokedex/pokemon">
							<div class="galeria-pokemones_box">
								<div class="galeria-pokemones_box_datos">
									...
									<span>Nombre:<xsl:value-of select="species"/>
									</span>
									<span>HP: <xsl:value-of select="baseStats/HP"/>
									</span>
									<span>ATK:<xsl:value-of select="baseStats/ATK"/>
									</span>
									<span>DEF:<xsl:value-of select="baseStats/DEF"/>
									</span>
									<span>SPED:<xsl:value-of select="baseStats/DEF"/>
									</span>
									<span>SATK:<xsl:value-of select="baseStats/SATK"/>
									</span>
